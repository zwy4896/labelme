...
class Canvas(QtWidgets.QWidget):
    ...
    def createMode(self, value):
        ...
        if value == "ai_polygon" and self._ai is None:
            self._ai = labelme.ai.SegmentClient(self._url)
            self._ai.set_image(labelme.utils.img_qt_to_arr(self.pixmap.toImage()))
    ...
    def paintEvent(self, event):
        ...
        if (
            ...
            points = self._ai._predict_polygon_from_points(
